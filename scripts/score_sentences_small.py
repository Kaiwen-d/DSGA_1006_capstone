...
dataset = load_dataset('multi_news', split='train').select([0,1,2,3,4]) #.select([0,1,2,3,4])
...
d.save_to_disk("/scratch/hw1685/DSGA_1006_capstone/dataset/scored_dataset_small")
